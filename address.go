// Copyright (c) 2013-2017 The ifishnet developers
...
func NewAddressPubKey(serializedPubKey []byte, net *chaincfg.Params) (*AddressPubKey, error) {
	pubKey, err := hdfec.ParsePubKey(serializedPubKey, hdfec.S256())
	if err != nil {
		return nil, err
	}

	// Set the format of the pubkey.  This probably should be returned
	// from hdfec, but do it here to avoid API churn.  We already know the
...
func (a *AddressPubKey) PubKey() *hdfec.PublicKey {
	return a.pubKey
}
