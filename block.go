...
// Tx returns a wrapped transaction (hdfutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (hdfutil.Tx) for all
...
// instead provides easy access to wrapped versions (hdfutil.Tx) of them.
