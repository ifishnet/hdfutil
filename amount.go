...
// monetary amount.
const (
	AmountMegaHDF  AmountUnit = 6
	AmountKiloHDF  AmountUnit = 3
	AmountHDF      AmountUnit = 0
	AmountMilliHDF AmountUnit = -3
	AmountMicroHDF AmountUnit = -6
...
//
// NewAmount is for specifically for converting HDF to Satoshi.
// For creating a new Amount with an int64 value which denotes a quantity of Satoshi,
// do a simple type conversion from type int64 to Amount.
// See GoDoc for example: http://godoc.org/github.com/ifishnet/hdfutil#example-Amount
...
// ToHDF is the equivalent of calling ToUnit with AmountHDF.
func (a Amount) ToHDF() float64 {
	return a.ToUnit(AmountHDF)
}
...
// String is the equivalent of calling Format with AmountHDF.
func (a Amount) String() string {
	return a.Format(AmountHDF)
}
